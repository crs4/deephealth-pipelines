  ...
  extract-tissue-low:
    run: &extract_tissue
      ...
      requirements:
        ...
        DockerRequirement:
          dockerPull: ***REMOVED***:5000/slaid:0.60.2-develop-tissue_model-extract_tissue_eddl_1.1
  ...
  classify-tumor:
    run: 
      ...
      requirements:
        InlineJavascriptRequirement: {}
        DockerRequirement:
          dockerPull: ***REMOVED***:5000/slaid:0.60.2-develop-tumor_model-classify_tumor_eddl_0.1
        InitialWorkDirRequirement:
          listing:
            -  $(inputs.src)
      inputs:
